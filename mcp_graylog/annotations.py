"""Tool annotation decorators (graylog flavor — uses ``mcp_server`` not ``mcp``).

Wraps ``mcp_server.tool(annotations=...)`` to give every tool an explicit
