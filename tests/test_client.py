"""Tests for the Graylog API client."""
...
class TestGraylogClient:
    ...
    def test_parse_time_range_invalid_format(self, client: GraylogClient) -> None:
    ...
    def test_make_request_success(self, mock_request: Mock, client: GraylogClient) -> None:
    ...
    @patch("requests.Session.request")
    def test_make_request_failure(self, mock_request: Mock, client: GraylogClient) -> None:
    ...
    def test_search_logs(self, mock_make_request: Mock, client: GraylogClient) -> None:
    ...
    @patch.object(GraylogClient, "_make_request")
    def test_search_logs_default_time_range(self, mock_make_request: Mock, client: GraylogClient) -> None:
    ...
    def test_search_logs_empty_query(self, client: GraylogClient) -> None:
    ...
    @patch.object(GraylogClient, "_make_request")
    def test_get_log_statistics(self, mock_make_request: Mock, client: GraylogClient) -> None:
    ...
    def test_get_log_statistics_empty_query(self, client: GraylogClient) -> None:
    ...
    def test_get_log_statistics_empty_field(self, client: GraylogClient) -> None:
    ...
    @patch.object(GraylogClient, "_make_request")
    def test_list_streams(self, mock_make_request: Mock, client: GraylogClient) -> None:
    ...
    @patch.object(GraylogClient, "_make_request")
    def test_get_stream_info(self, mock_make_request: Mock, client: GraylogClient) -> None:
    ...
    def test_get_stream_info_empty_id(self, client: GraylogClient) -> None:
    ...
    @patch.object(GraylogClient, "_make_request")
    def test_get_system_info(self, mock_make_request: Mock, client: GraylogClient) -> None:
    ...
    def test_test_connection_success(self, mock_get: Mock, mock_get_system_info: Mock, client: GraylogClient) -> None:
    ...
    @patch.object(GraylogClient, "get_system_info")
    def test_test_connection_failure(self, mock_get_system_info: Mock, client: GraylogClient) -> None:
    ...
    def test_search_stream_logs(self, mock_search_logs: Mock, client: GraylogClient) -> None:
    ...
    def test_search_stream_logs_empty_stream_id(self, client: GraylogClient) -> None:
    ...
    def test_search_stream_logs_empty_query(self, client: GraylogClient) -> None:
...
class TestQueryParams:
    ...
    def test_query_params_creation(self) -> None:
    ...
    def test_query_params_defaults(self) -> None:
...
class TestAggregationParams:
    ...
    def test_aggregation_params_creation(self) -> None:
    ...
    def test_aggregation_params_with_interval(self) -> None:
